...
class CNNiTransformerBiLSTM(LightningModule):
    def __init__(
            self,
        ...
        self.lstm = nn.LSTM(input_size=self.cnn_out_channels,
                            # The number of output channels from iTransformer is the input size for LSTM
    ...
    def forward(self, input_seq: torch.Tensor):
        ...
        iTransformer_output = self.iTransformer_layer(enc_input, mark_enc, dec_input,
        ...
        lstm_output, hidden = self.lstm(iTransformer_output,
