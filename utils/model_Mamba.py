...
from .Mamba.MambaTimeSeries import MambaTimeSeries as Mamba_layer


class Mamba(LightningModule):
    def __init__(
            self, 
        ...
        self.mamba = Mamba_layer(
            ...
            output_dim=self.out_var,
            d_model=self.hidden_size,
            state_size=self.state_size,
            num_layers=self.num_layers,
            conv_kernel=self.kernel_size,
            prediction_horizon=self.num_days_to_predict
        )
    ...
    def forward(self, input_seq: torch.Tensor):
        ...
        output = self.mamba(input_seq)  # shape: (batch_size, seq_len_to_predict, out_var)
