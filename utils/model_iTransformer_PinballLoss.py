...
from .iTransformer.iTransformer_new import Model as iTransformer_layer
...
class iTransformer(LightningModule):
    def __init__(
            self,
        ...
        self.iTransformer_layer = iTransformer_layer(
    ...
    def forward(self, input_seq: torch.Tensor):
        ...
        pred = iTransformer_output[:, :, -self.out_var]  # shape: (batch_size, seq_len_to_predict)
